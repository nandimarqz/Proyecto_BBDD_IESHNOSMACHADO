...
ADD CONSTRAINT CONTADOR_PK PRIMARY KEY(COD_CONTADOR)
    CONSTRAINT CONTADOR_TIPO_CK CHECK(TIPO IN ('GAS', 'ELECTRICIDAD'))
    CONSTRAINT CONTADOR_FK_COD_CATASTRAL FOREIGN KEY (COD_CATASTRAL) REFERENCES INMUEBLE(COD_CATASTRAL);